...
xhs-stealth-crawler 不是一套新爬虫，而是一组专门为 MediaCrawler 设计的行为加固层——它通过修改 JS 指纹、打乱时序、模拟人类操作等方式，显著降低被小红书风控系统识别的概率。
...
风控系统本质上是在计算"这个会话有多像机器人"。xhs-stealth-crawler 的设计思路，就是逐层擦除上述信号，让会话在模型眼中尽可能落在"像人"的分布内。
